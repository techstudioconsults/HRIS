...
export const welcomeTourSteps: DriveStep[] = [
  {
    popover: {
      ...
      description:
        "This interactive tour will guide you through the setup process. Let's get started!",
    },
  },
  {
    ...
    popover: {
      title: 'Video Tour',
      description:
        "Click here to watch a quick video overview of the platform's key features.",
      side: 'bottom',
      align: 'start',
    },
  },
  {
    ...
    popover: {
      title: 'Skip to Setup',
      description:
        'Or skip the video and start setting up your company profile right away.',
      side: 'bottom',
      align: 'start',
    },
  },
...
export const stepOneTourSteps: DriveStep[] = [
  {
    popover: {
      ...
      description:
        "Let's set up your company profile. This information helps personalize your HR experience.",
    },
  },
  {
...
export const stepTwoTourSteps: DriveStep[] = [
  ...
  },
  {
    ...
    popover: {
      ...
      description:
        "Need a team that's not listed? Click here to create a custom department.",
      side: 'top',
      align: 'start',
    },
  },
  {
    ...
    popover: {
      ...
      description:
        "Need a role that's not listed? Click here to create a custom role for any team.",
      side: 'top',
      align: 'start',
    },
  },
...
export const stepThreeTourSteps: DriveStep[] = [
  ...
  },
  {
    ...
    popover: {
      ...
      description:
        'Click here to add additional employees to your organization.',
      side: 'top',
      align: 'start',
    },
  },
