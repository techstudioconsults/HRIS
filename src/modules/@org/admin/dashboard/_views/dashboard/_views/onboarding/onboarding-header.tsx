  ...
  return (
    <section className="flex flex-col items-start gap-4 sm:flex-row sm:items-center sm:justify-between">
      <div className="flex flex-col gap-2">
        <h5 className="text-h5 font-semibold">Getting Started Checklist</h5>
        <p className={`text-gray`}>Complete these key steps to set up your company and get started quickly</p>
      </div>
