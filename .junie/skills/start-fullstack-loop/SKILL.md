---
name: start-fullstack-loop
description: Start a new fullstack feature development loop
tags: [feature, fullstack, planning]
---

We are starting a new fullstack feature loop.

**Feature:** <describe the feature in your task prompt>

## Phases

Planner → Architect → Backend Implementer → Frontend Implementer → Reviewer → Optimizer

## Workflow

Load `/home/kingsley/blackbox/.ai/fullstack/workflows/fullstack-feature.md` for the detailed phase instructions.
