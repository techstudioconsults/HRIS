...
import { Notification } from "@/components/shared/notification-widget";
...
export function ExampleLayoutEmptyNotifications() {
  return (
    <div>
      <TopBar adminName="Jane Smith" adminEmail="jane@example.com" adminRole="HR Manager" notifications={[]} />
      {/* Rest of your layout */}
    </div>
  );
}
