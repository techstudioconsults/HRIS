    ...
    <section className="px-6 md:px-12 py-10 bg-white">
      ...
      >
        <div className="relative z-10 flex flex-col items-center gap-6 max-w-2xl mx-auto">
          <h2 className="text-3xl md:text-[48px] font-bold text-white leading-tight">{title}</h2>
          <p className="text-white/90 text-base md:text-[18px] leading-relaxed max-w-lg">
            {description.includes('<br') ? <span dangerouslySetInnerHTML={{ __html: description }} /> : description}
          </p>
