import { useCallbackRef } from "@/hooks/use-callback-reference";
...
function useControllableState<T>({ prop, defaultProp, onChange = () => {} }: UseControllableStateParameters<T>) {
...
function useUncontrolledState<T>({ defaultProp, onChange }: Omit<UseControllableStateParameters<T>, "prop">) {
