  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-10 text-black">
      ...
      <div className="mb-12 flex flex-col gap-4">
        <p className="text-[20px] leading-[1.5] font-normal">
          {intro.description}
        </p>
        {intro.agreement && (
          <p className="text-[20px] leading-[1.5] font-normal">
        ...
        {sections.map((section) => (
          ...
          >
            ...
            <div className="flex flex-col gap-4">
              {section.content && (
                <div className="text-[20px] leading-[1.5]">
                  {section.content}
                </div>
              )}
                ...
                <div className="flex flex-col gap-6">
                  {section.subsections.map((sub, idx) => (
                    <div key={idx} className="flex flex-col gap-2">
                      ...
                      {sub.note && (
                        <p className="text-[20px] leading-[1.5]">{sub.note}</p>
                      )}
                    </div>
                  ))}
                </div>
              ...
              {section.note && (
                <p className="text-[20px] leading-[1.5]">{section.note}</p>
              )}
            </div>
          </section>
        ))}
