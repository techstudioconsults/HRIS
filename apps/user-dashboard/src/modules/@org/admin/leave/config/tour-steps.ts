...
export const leaveSetupTourSteps: DriveStep[] = [
  ...
  },
  {
    ...
    popover: {
      title: 'Approvers',
      description:
        'Select employees who can approve leave requests. Typically managers or HR personnel.',
      side: 'right',
      align: 'start',
    },
  },
...
export const leaveOverviewTourSteps: DriveStep[] = [
  ...
  },
  {
    ...
    popover: {
      ...
      description:
        'Use these filters to find specific leave requests by status, type, or employee.',
      side: 'bottom',
      align: 'start',
    },
  },
