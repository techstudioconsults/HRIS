...
export const NewsLetter = () => {
  return (
    <main className="bg-primary relative flex h-[258px] items-center justify-center rounded-xl">
      <div
        className="bg-secondary/20 absolute top-4 left-4 h-12 w-12 rounded-full blur-2xl"
        aria-hidden="true"
      />
        ...
        <div className="mt-3 lg:mt-7">
          ...
          >
            ...
            <div className="text-center">
              <MainButton
                className="bg-secondary text-background mt-3 w-[178px] rounded-full xl:mt-0"
                size="lg"
              >
                Subscribe
              </MainButton>
      ...
      <div
        className="bg-secondary/20 absolute right-4 bottom-4 h-12 w-12 rounded-full blur-2xl"
        aria-hidden="true"
      />
    </main>
  );
