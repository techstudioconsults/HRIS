    ...
    return (
      <div
        ...
        className={cn(
          ...
          ' flex h-[50%] w-(--sidebar-width) flex-col',
          className
        )}
        {...properties}
      >
    ...
    >
      ...
      <div
        ...
        className={cn(
          ...
          variant === 'floating' || variant === 'inset'
            ? 'p-2 group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)+(--spacing(4))+2px)] overflow-hidden'
            : 'group-data-[collapsible=icon]:w-(--sidebar-width-icon)',
          className
        )}
        {...properties}
      >
        <div
          ...
          className="bg-sidebar bg-sidebar-bg group-data-[variant=floating]:border-sidebar-border
