...
export const payrollSetupTourStep: DriveStep[] = [
  {
    ...
    popover: {
      ...
      description:
        'Great job setting up your payroll policy. The final step is to set up ' +
        'your payment wallet to start processing payroll.',
      side: 'right',
      align: 'start',
    },
  },
...
export const generatePayrollTourStep: DriveStep[] = [
  {
    ...
    popover: {
      ...
      description:
        'Click here to generate payroll for the current pay period.' +
        ' This will calculate salaries, bonuses, and deductions for all employees.',
      side: 'right',
      align: 'start',
    },
  },
