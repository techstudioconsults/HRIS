...
Project-specific overrides (if any) are in `.ai/context/` (shared with all agents).

---

## Memory & State Paths

> These files are shared across all agents (Kilo, Claude, Junie). Any agent can read or write them.
