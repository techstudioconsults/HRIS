...
export const EditEmployeeForm = () => {
  ...
  // Query hooks
  const { useGetAllTeams, useGetEmployeeById, useUpdateEmployee } =
    useEmployeeService();
            ...
            <fieldset className={sectionClassName}>
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-8">
                <FormField
                  ...
                  type="text"
                  placeholder={
                    loadingEmployee ? `Loading first name...` : `John`
                  }
                ...
                <FormField
                  name="dateOfBirth"
                  placeholder={
                    loadingEmployee ? `Loading date of birth...` : ``
                  }
                  label="Date of Birth"
                  className="border-border h-14! w-full"
                  type="date"
            ...
            <fieldset className={sectionClassName}>
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-8">
                <FormField
                  ...
                  type="number"
                  placeholder={
                    isHydrating ? `Loading base salary...` : `800000`
                  }
                  className="border-border h-14! w-full"
                  disabled={isHydrating || isSubmitting}
                  required
                ...
                <FormField
                  ...
                  type="text"
                  placeholder={
                    isHydrating ? `Loading account name...` : `John Doe`
                  }
                  className="border-border h-14! w-full"
                  disabled={isHydrating || isSubmitting}
                  required
                ...
                <FormField
                  ...
                  type="text"
                  placeholder={
                    isHydrating ? `Loading account number...` : `0323904127`
                  }
                  className="border-border h-14! w-full"
                  disabled={isHydrating || isSubmitting}
                  required
